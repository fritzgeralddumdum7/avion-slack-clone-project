...
function AddMember ({channelId, channelName, channelMembersIds,  setChannelMembersIds, setAddMemberClicked, channelMembers, setChannelMembers, getChannelMembers}) { 
    ...
    return (
        <div className='container-add-member'>
            ...
            <div className="d-flex">
                ...
                <button onClick={handleAddUserButton}>Add Users</button>
        </div>
